...
public partial class NwutechTrendssContext : DbContext
{
    public NwutechTrendssContext()
    {
    }

    public NwutechTrendssContext(DbContextOptions<NwutechTrendssContext> options)
        : base(options)
    {
    }
